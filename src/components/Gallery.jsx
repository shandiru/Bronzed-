  ...
  const galleryItems = [
    {
      ...
      title: "Timeless Bridal Glam",
      desc: "A soft, radiant bridal look created to photograph beautifully and last throughout the day.",
      image: "/n1.webp",
    },
    {
      id: 2,
      ...
      desc: "Fresh, glowing makeup with refined definition for a polished and elegant finish.",
      image: "/n2.webp",
    },
    {
      id: 3,
      ...
      desc: "Beautiful occasion makeup perfect for parties, evenings out, and special celebrations.",
      image: "/n3.webp",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-sage max-w-2xl mx-auto leading-relaxed">
            Explore a selection of signature makeup looks by Bronzed By Talia.
          </p>
        </div>
